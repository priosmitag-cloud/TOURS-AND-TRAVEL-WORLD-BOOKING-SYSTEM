...
<body>
    ...
    <div class="container contact-section">
        <div class="row">
            ...
            <!-- Left Side -->
            <div class="col-md-6">
                <h2 class="fw-bold">We’re Just a Message Away</h2>
                <br>
            ...
            <div class="col-md-6">
                <div class="contact-form">
                    <h5 class="fw-bold mb-3">Registration Form</h5>
                    
                    <form action="insert.php" method="post">
                        <div class="mb-3">
                            <input type="text" class="form-control" placeholder="Full Name" name="uname" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3 d-flex">
                            ...
                            <input type="tel" class="form-control" placeholder="Phone Number" name="unumber" required>
                        </div>
                        <div class="mb-3">
                            <input type="date" class="form-control" name="date" required>
                        </div>
                        <div class="mb-3">
                            <textarea class="form-control" rows="3" placeholder="Message" name="umessage"></textarea>
                        </div>
                        <button type="submit" class="btn btn-submit px-4" name="submit">Register Now</button>
                    </form>
                </div>
            </div>
